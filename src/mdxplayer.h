...
public:
    MDXPlayer() : stream(0), mdxBuffer(NULL), pdxBuffer(NULL)
    {
...
private:
    // The instance callback, where we have access to every method/variable in object of class MDXPlayer 
        ...
        void *userData )
    {
        ...
        return ((MDXPlayer*)userData)->paCallbackMethod(inputBuffer, outputBuffer,
            framesPerBuffer,
            timeInfo,
            statusFlags);
    }
